...
public class ShadowDisplayTest {
  ...
  @Test
  @Config(minSdk = N)
  public void addDisplayHdrCapabilities_shouldReturnHdrCapabilities() {
    ...
    ShadowDisplayManager.addDisplayHdrCapabilities(
  ...
  @Test
  @Config(minSdk = M)
  public void addDisplayHdrCapabilities_shouldNotThrowException() {
    Display display = ShadowDisplay.getDefaultDisplay();
    int[] hdrCapabilities =
        new int[] {HdrCapabilities.HDR_TYPE_HDR10, HdrCapabilities.HDR_TYPE_DOLBY_VISION};
    ShadowDisplayManager.addDisplayHdrCapabilities(
